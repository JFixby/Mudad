 ...
 *
 *
 * @version $Revision: 1.7 $, $Date: 2005/05/06 18:07:28 $
...
public class SizeStrainSymIso extends SizeStrainSymModel {
  ...
  public SizeStrainSymIso(String[] labels) {
    this();
    if (labels != null) {
      if (labels.length > 1) {
        identifier = labels[0];
  ...
  public void initParameters() {
    ...
    parameterField[0] = new Parameter(this, getParameterString(0), 500,
            ParameterPreferences.getDouble(getParameterString(0) + ".min", 5),
            ParameterPreferences.getDouble(getParameterString(0) + ".max", 10000));
