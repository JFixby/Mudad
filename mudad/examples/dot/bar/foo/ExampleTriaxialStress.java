/*
 * @(#)ExampleTriaxialStress.java created 10/3/2006 Pergine Vals.
 *
...
/**
 *  The ExampleTriaxialStress is a class to compute the diffraction shift from
...
public class ExampleTriaxialStress extends Strain {

  // Dictionary, here we define the CIF string for each parameter and option in the model, will be used for
  // saving and loading files
  public static String[] diclistc = {"_rista_deviatoric_part_only", // this is an option (stringField)

                                     "_rista_elastic_modulus_E",  // from here are parameters (parameterField)
  ...
  final static String id = "Example Triaxial Stress Isotropic E";
  ...
  // **********************************************************************************
  public ExampleTriaxialStress(XRDcat aobj, String alabel) {
    super(aobj, alabel);
    initXRD();
    identifier = id;
    IDlabel = id;
  ...
  public ExampleTriaxialStress(XRDcat aobj) {
    this(aobj, id);
  }

  public ExampleTriaxialStress(String[] labels) {
    this();
    if (labels != null) {
      if (labels.length > 1) {
        identifier = labels[0];
